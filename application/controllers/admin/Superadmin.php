...
class Superadmin extends CI_Controller
{
	...
	public function menuwebsite()
	{
		...
		$this->load->view('admin/v_menuwebsite', $data);
	}
	...
	public function editmasterdataberita($id_berita = '')
	{
	    $valid = $this->form_validation;
	...
	public function editdataiklanfooter($id_iklan = '')
	{
	    $valid = $this->form_validation;
