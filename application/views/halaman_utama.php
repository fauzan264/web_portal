...
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/bootstrap.min.css') ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/font-awesome.min.css') ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/animate.css') ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/slick.css') ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/theme.css') ?>">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/dashboard1/css/style.css') ?>">
<!--[if lt IE 9]>
        ...
        <div class="col-lg-6 col-md-6 col-sm6">
          <div class="latest_slider">
            <div class="slick_slider">
              <div class="single_iteam"><img src="<?= base_url('assets/dashboard1/img/550x330x1.jpg'); ?>" alt="">
                <h2><a class="slider_tittle" href="pages/single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              </div>
              <div class="single_iteam"><img src="<?= base_url('assets/dashboard1/img/550x330x2.jpg'); ?>" alt="">
                <h2><a class="slider_tittle" href="pages/single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              </div>
              <div class="single_iteam"><img src="<?= base_url('assets/dashboard1/img/550x330x3.jpg'); ?>" alt="">
                <h2><a class="slider_tittle" href="pages/single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              </div>
              <div class="single_iteam"><img src="<?= base_url('assets/dashboard1/img/550x330x4.jpg'); ?>" alt="">
                <h2><a class="slider_tittle" href="pages/single.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              </div>
            </div>
          </div>
          ...
          <div class="content_top_right">
            <ul class="featured_nav wow fadeInDown">
              <li style="width: 560px ;height: 430px">
                <img class="" src="<?= base_url('assets/admin/upload/iklan/'.$iklan_sidebar1['img_iklan']); ?>" alt="<?= $iklan_sidebar1['judul_iklan']; ?>" > 
                <div class="title_caption">
                  <a href="<?= $iklan_sidebar1['url_iklan']; ?>" ><?= $iklan_sidebar1['judul_iklan']; ?></a>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-3">
        <div class="content_middle_leftbar">
          <div class="single_category wow fadeInDown">
            ...
            <ul class="catg1_nav">
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="<?= base_url('assets/dashboard1/img/292x150x1.jpg'); ?>"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="<?= base_url('assets/dashboard1/img/292x150x2.jpg'); ?>"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
            </ul>
          </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="content_middle_middle">
          <div class="slick_slider2">
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?= base_url('assets/dashboard1/img/567x330x1.jpg'); ?>" alt=""></a>
            ...
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?= base_url('assets/dashboard1/img/567x330x2.jpg'); ?>" alt=""></a>
              <h2><a href="#">Praesent vitae quam vitae arcu posuer 2</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui lectus, pharetra nec elementum eget, vulput...</p>
            </div>
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="<?= base_url('assets/dashboard1/img/567x330x3.jpg'); ?>" alt=""></a>
          ...
          <div class="single_category wow fadeInDown">
            ...
            <div class="business_category_left wow fadeInDown">
              <ul class="fashion_catgnav">
                <li>
                  <div class="catgimg2_container"> <a href="pages/single.html"><img alt="" src="<?= base_url('assets/dashboard1/img/390x240x1.jpg'); ?>"></a> </div>
            ...
            <div class="business_category_right wow fadeInDown">
              <ul class="small_catg">
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="pages/single.html"><img src="<?= base_url('assets/dashboard1/img/112x112.jpg'); ?>" alt=""></a>
                ...
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="#"><img src="<?= base_url('assets/dashboard1/img/112x112.jpg'); ?>" alt=""></a>
                    <div class="media-body">
            ...
            <div class="games_category">
              <div class="single_category">
                ...
                <ul class="small_catg wow fadeInDown">
                  <li>
                    <div class="media"> <a class="media-left" href="#"><img src="<?= base_url('assets/dashboard1/img/112x112.jpg'); ?>" alt=""></a>
                      <div class="media-body">
                        <h4 class="media-heading"><a href="#">Duis condimentum nunc pretium lobortis </a></h4>
                        <div class="comments_box"> <span class="meta_date">14/12/2045</span> <span class="meta_comment"><a href="#">No Comments</a></span> </div>
                      </div>
            ...
            <div class="fashion_category">
              <div class="single_category">
                <div class="single_category wow fadeInDown">
                  ...
                  <ul class="fashion_catgnav wow fadeInDown">
                    <li>
                      <div class="catgimg2_container"> <a href="#"><img alt="" src="<?= base_url('assets/dashboard1/img/390x240x1.jpg'); ?>"></a> </div>
                      <h2 class="catg_titile"><a href="#">Aenean mollis metus sit amet ligula adipiscing</a></h2>
                      <div class="comments_box"> <span class="meta_date">14/12/2045</span> <span class="meta_comment"><a href="#">No Comments</a></span> <span class="meta_more"><a  href="#">Read More...</a></span> </div>
                      <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla...</p>
                    </li>
        ...
        <div class="content_bottom_right">
          <div class="single_bottom_rightbar">
            ...
            <ul class="small_catg popular_catg wow fadeInDown">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"><img alt="" src="<?= base_url('assets/dashboard1/img/112x112.jpg'); ?>"> </a>
                  <div class="media-body">
                    <h4 class="media-heading"><a href="#">Duis condimentum nunc pretium lobortis </a></h4>
          ...
          <div class="single_bottom_rightbar wow fadeInDown">
            ...
            <a href="<?= $iklan_sidebar2['url_iklan']; ?>#" >
              <img class="img-iklan" src="<?= base_url('assets/admin/upload/iklan/'.$iklan_sidebar2['img_iklan']); ?>" alt="<?= $iklan_sidebar2['judul_iklan']; ?>" style="width: 100%; height: 150px;"> 
            </a>
          </div>
          <div class="single_bottom_rightbar wow fadeInDown">
            <a href="<?= $iklan_sidebar3['url_iklan']; ?>#" >
              <img class="img-iklan" src="<?= base_url('assets/admin/upload/iklan/'.$iklan_sidebar3['img_iklan']); ?>" alt="<?= $iklan_sidebar3['judul_iklan']; ?>" style="width: 100%; height: 150px;"> 
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="single_footer_top wow fadeInLeft">
            ...
            <ul class="flicker_nav">
              <li><a href="#"><img src="<?= base_url('assets/dashboard1/img/75x75.jpg'); ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= base_url('assets/dashboard1/img/75x75.jpg'); ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= base_url('assets/dashboard1/img/75x75.jpg'); ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= base_url('assets/dashboard1/img/75x75.jpg'); ?>" alt=""></a></li>
              <li><a href="#"><img src="<?= base_url('assets/dashboard1/img/75x75.jpg'); ?>" alt=""></a></li>
...
<script src="<?= base_url('assets/dashboard1/js/jquery.min.js'); ?>"></script> 
<script src="<?= base_url('assets/dashboard1/js/bootstrap.min.js'); ?>"></script> 
<script src="<?= base_url('assets/dashboard1/js/wow.min.js'); ?>"></script> 
<script src="<?= base_url('assets/dashboard1/js/slick.min.js'); ?>"></script> 
<script src="<?= base_url('assets/dashboard1/js/custom.js'); ?>"></script>
</body>
</html>