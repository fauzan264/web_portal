  ...
  <div class="wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <form method="post" action="<?php echo base_url('admin/superadmin/editmasterdataberita');?>" enctype="multipart/form-data"> 
              <div class="col-md-12">
                <div class="form-group">
                  <label>Judul Berita</label>
                  <input type="hidden" name="id_berita" id="id_berita" class="form-control" value="<?php echo (isset($id_berita)) ? $id_berita : "";?>">
                  <input type="text" name="judul_berita" id="judul_berita" class="form-control" value="<?php echo (isset($judul_berita)) ? $judul_berita : "";?>">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  <label>Author</label>
                  <input type="text" name="author" id="author" class="form-control" value="<?php echo (isset($author)) ? $author : "";?>">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Gambar</label>
                  <input type="file" name="gambar" id="gambar" class="form-control" value="<?php echo (isset($gambar)) ? $gambar : "";?>">
                </div>  
              </div>  
              <!-- /.col -->
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="editor1" name="isi_berita" id="isi_berita" rows="10" cols="80"><?php echo (isset($isi_berita)) ? $isi_berita : "";?></textarea>
                </div>  
              </div>  
              <div class="col-md-12">
                <div class="form-group">
