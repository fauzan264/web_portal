            ...
            <form method="post" action="<?php echo base_url('admin/superadmin/editdataiklanfooter');?>" enctype="multipart/form-data"> 
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="img_iklan" id="img_iklan" class="form-control" value="<?php echo (isset($img_iklan)) ? $img_iklan : "";?>">
                  <span style="font-size: .9em; font-style: italic">
                    Data harus berformat jpg dan png dengan ukuran 1170 x 150
                  </span>
                </div>
              </div>
              <div class="col-md-12">
