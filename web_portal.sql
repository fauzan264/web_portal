...
delete from tbl_admin where

select * from tbl_admin
describe tbl_admin

delete from tbl_admin where username='Fauzan';

insert into tbl_admin values(
  '', 'Fauzan', 'Ahmad Fauzan', 'fauzan.c4@gmail.com', md5('admin'),087925479879, 'Super Admin', current_timestamp, 'aktif'
)

alter drop `tbl_admin`;